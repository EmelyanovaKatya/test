...
**Пример 1** — простой фактический вопрос:
...
- Answer: **«Apollo»** / **«Apollo program»**

**Пример 3** — несколько gold-ответов (характерно для validation split):
- Context: фрагмент про погодное явление
- Question: *«What forms when water vapor condenses and falls under gravity?»*
- Answers: **["precipitation", "Precipitation", "precipitation"]** — несколько аннотаторов дали практически идентичный, но не побуквенно совпадающий ответ; при подсчёте метрик берётся максимум по всем вариантам
